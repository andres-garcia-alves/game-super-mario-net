            ...
            Try
                For i As Integer = 0 To lstHighScores.Count - 1
                    If iTestValue > lstHighScores(i).Points Then
                        ...
                        Dim sMessage1 As String = cLanguaje.GetTextElement("frmGameHighScore", 1)
                        Dim sMessage2 As String = cLanguaje.GetTextElement("frmGameHighScore", 2)

                        Dim sName As String = InputBox(sMessage1 & NAME_MAX_LENGHT & sMessage2, sTitle, "Empty", iPosX, iPosY)
