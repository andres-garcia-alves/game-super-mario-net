...
Namespace SuperMarioNet.Miscellaneous
    ...
    Public Class cMusic
        ...
        Private ReadOnly lCB As Long = 0
        ...
        Private ReadOnly isMusicOn As Boolean = False
        Private ReadOnly basePath As String = String.Empty
        ...
        Public Sub New()
            Try
                ...
                isMusicOn = CType(IIf(ConfigurationManager.AppSettings("music") = "ON", True, False), Boolean)

                ' don't load resources if music is Off
                If Not isMusicOn Then Return

                basePath = ConfigurationManager.AppSettings("pathSounds")
        ...
        Public Sub PlayMusic(ByVal eTheme As eMusicTheme, ByVal bRepeat As Boolean)
            ...
            If bRepeat Then ' play infinitely?
                MyTimer.Interval = GetThemeLenght(eTheme) + SAFETY_DELAY
                MyTimer.Start()
            End If
        End Sub
        ...
        ' </summary>
        Private Sub TimeElapsed(ByVal sender As Object, ByVal e As System.Timers.ElapsedEventArgs) Handles MyTimer.Elapsed
            lRet = mciSendString("stop " & GetThemeSeq(eCurrentTheme), sRetString, 128, lCB)
        ...
        Private Function GetThemePath(ByVal eTheme As eMusicTheme) As String
            Select Case eTheme
                Case eMusicTheme.CastleTheme : Return basePath & PATH_CASTLE_THEME
                Case eMusicTheme.Death : Return basePath & PATH_DEATH
                Case eMusicTheme.FinishMap : Return basePath & PATH_FINISH_MAP
                Case eMusicTheme.FinishWorld : Return basePath & PATH_FINISH_WORLD
                Case eMusicTheme.Go : Return basePath & PATH_GO
                Case eMusicTheme.LiveUp : Return basePath & PATH_LIVE_UP
                Case eMusicTheme.MarioTheme : Return basePath & PATH_MARIO_THEME
                Case eMusicTheme.MarioThemeHurry : Return basePath & PATH_MARIO_THEME_HURRY
                Case eMusicTheme.MarioThemeReggae : Return basePath & PATH_MARIO_THEME_REGGAE
                Case eMusicTheme.MarioThemeTechno : Return basePath & PATH_MARIO_THEME_TECHNO
                Case eMusicTheme.TimeWarnning : Return basePath & PATH_TIME_WARNNING
                Case eMusicTheme.UnderworldTheme : Return basePath & PATH_UNDERWORLD_THEME
                Case eMusicTheme.WaterTheme : Return basePath & PATH_WATER_THEME
