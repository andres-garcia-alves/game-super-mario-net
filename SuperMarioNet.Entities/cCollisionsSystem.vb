...
Namespace SuperMarioNet.Entities
    ...
    Public Class cCollisionsSystem
        ...
        Private Shared ReadOnly lstCollisionObjects As New List(Of cCollisionBase)
        ...
        Public Shared Function CheckValidMovement(ByVal oTest As cCollisionBase, ByVal NotifyIfWillCollide As Boolean,
        ...
        ByVal iMovement As Integer, ByVal MoveHorizDir As cCollisionBase.eMoveHorizDir, ByVal MoveVertDir As cCollisionBase.eMoveVertDir) As Boolean
            ...
            For i As Integer = 0 To lstCollisionObjects.Count - 1
                ...
                If (oTest.GetHashCode() <> lstCollisionObjects(i).GetHashCode() AndAlso
                    ...
                    If Not (CheckPositionX + oTest.GetWidth() < lstCollisionObjects(i).PositionX) And
                       Not (CheckPositionX > lstCollisionObjects(i).PositionX + lstCollisionObjects(i).GetWidth()) And
                       Not (CheckPositionY + oTest.GetHeight() < lstCollisionObjects(i).PositionY) And
        ...
        Public Shared Sub CheckCollisions()
            ...
            For i As Integer = 0 To lstCollisionObjects.Count - 1
                For j As Integer = 0 To lstCollisionObjects.Count - 1
                    ...
                    If (i < lstCollisionObjects.Count AndAlso j < lstCollisionObjects.Count AndAlso lstCollisionObjects(i).CollisionCheck AndAlso
                        ...
                        If Not (lstCollisionObjects(i).PositionX + lstCollisionObjects(i).GetWidth() < lstCollisionObjects(j).PositionX) And
                           Not (lstCollisionObjects(i).PositionX > lstCollisionObjects(j).PositionX + lstCollisionObjects(j).GetWidth()) And
                           Not (lstCollisionObjects(i).PositionY + lstCollisionObjects(i).GetHeight() < lstCollisionObjects(j).PositionY) And
