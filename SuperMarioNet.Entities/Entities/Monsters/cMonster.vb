...
Namespace SuperMarioNet.Entities.Entities
    ...
    Public Class cMonster
        ...
        Private ReadOnly _eMonsterType As eMonsterType
        Private _eMoveStatus As eMonsterMoveStatus

        Private ReadOnly oImage As Image
        Private ReadOnly lstMoveLeft As New List(Of Image)
        Private ReadOnly lstMoveRight As New List(Of Image)
        ...
        Public Overrides Sub CollisionedBy(ByVal oCollision As cCollisionBase)
            ...
            If oCollision.GetType().Equals(Type.GetType("SuperMarioNet.Entities.Entities.cPlayer")) Then
            ...
            ElseIf oCollision.GetType().Equals(Type.GetType("SuperMarioNet.Entities.Entities.cStaticObject")) Then
            ...
            ElseIf oCollision.GetType().Equals(Type.GetType("SuperMarioNet.Entities.Entities.cShot")) Then
