...
Namespace SuperMarioNet.Entities.Entities
    ...
    Public Class cPlayer
        ...
        Private ReadOnly _oShots As New cShots
        ...
        Private ReadOnly lstSmallMoveLeft As New List(Of Image)
        Private ReadOnly lstSmallMoveRight As New List(Of Image)
        ...
        Private ReadOnly lstNormalMoveLeft As New List(Of Image)
        Private ReadOnly lstNormalMoveRight As New List(Of Image)
        ...
        Private ReadOnly lstFireMoveLeft As New List(Of Image)
        Private ReadOnly lstFireMoveRight As New List(Of Image)
        Private oShotingLeft, oShotingRight As Image

        ' jump & gravity
        Private byGap As Integer = PLAYER_VERT_MOVEMENT
        Private iJumpStep As Integer = 0
        ' Private ReadOnly bFallingDown As Boolean = False
        ...
        Public Overrides Sub CollisionedBy(ByVal oCollision As cCollisionBase)
            ...
            If oCollision.GetType.Equals(Type.GetType("SuperMarioNet.Entities.Entities.cMonster")) Then ' player hit a monster
