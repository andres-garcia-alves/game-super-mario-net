...
Public Class frmMenu
    ...
    Private Sub btnHowTo_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnHowTo.Click
    ...
    Private Sub btnHighScores_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnHighScores.Click
    ...
    Private Sub btnEditor_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnEditor.Click
        Try
            ...
            MessageBox.Show("Feature no available yet.", My.Application.Info.Title, MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub btnGeneric_GotFocus(ByVal sender As Object, ByVal e As EventArgs) Handles btnPlay.GotFocus, btnOptions.GotFocus, btnHowTo.GotFocus, btnHighScores.GotFocus, btnExit.GotFocus, btnEditor.GotFocus, btnCredits.GotFocus
        For i As Integer = 0 To Me.Controls.Count - 1
            If Me.Controls(i).GetType.FullName = "System.Windows.Forms.Button" Then
                If CType(Me.Controls(i), Button).Focused Then
