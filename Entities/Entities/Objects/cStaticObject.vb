...
Namespace SuperMarioNet.Entities
    ...
    Public Class cStaticObject
        ...
        Private _eObject As eObjectType

        Private oImage As Image
        Private lstImages As New List(Of Image)

        Private eDraw As eDrawType = eDrawType.StaticImage

        Private bStartUpVisible As Boolean ' used on reset
        Private eStartUpDrawType As eDrawType ' used on reset
        ...
        Public Overrides Sub CollisionedBy(ByVal oCollision As cCollisionBase)
            ...
            If oCollision.GetType.Equals(Type.GetType("Entities.SuperMarioNet.Entities.cPlayer")) Then ' hitted by the player
